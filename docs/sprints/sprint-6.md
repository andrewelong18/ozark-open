...
- [ ] Walk Pat through one simulated Thursday night: close Phase 1 via upload, then upload results, unaided. *(Human work — full simulation script in #30; runs after the prod chain #12 → #15 → #22, the users read-all policy #28, and the Sprint 6 PR merge.)*

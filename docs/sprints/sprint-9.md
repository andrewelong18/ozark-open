...
- [ ] Fix everything the dry run surfaces. *(The Jul 31 run's 21 findings became Sprints 21–25 and are **all shipped** as of Aug 9, 2026 — the last was the avatar RLS P0 [#90](https://github.com/andrewelong18/ozark-open/issues/90), whose prod browser check carries on as [#145](https://github.com/andrewelong18/ozark-open/issues/145). This box stays open for the **group** run's findings, which don't exist yet. Stakeholder questions and coverage gaps it raised: [#110](https://github.com/andrewelong18/ozark-open/issues/110), [#111](https://github.com/andrewelong18/ozark-open/issues/111).)*

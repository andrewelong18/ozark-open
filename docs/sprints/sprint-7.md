...
**Done when:** the numbers match Pat's hand-math for any user, including the void case. *(Verified locally — 113 unit tests incl. the worked example + void case, PG16 round trip for the view's SQL, build + lint. Prod verification and Pat's confirmation tracked in the Sprint 7 issues.)*

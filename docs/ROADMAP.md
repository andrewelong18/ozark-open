...
| [20](sprints/sprint-20.md) | Admin people console (roster + participants, merged) | 🔲 planned Jul 25, 2026 — consolidation sprint: the Sprint 10 roster and the Sprint 16 approval page are two views of one access funnel and disagree about who exists (the latter hides members who abandoned onboarding); merging them shrinks the admin surface from four custom pages to three and folds in #82's bulk invite entry. One open decision in the file: audit trail or not | none hard; builds on 10 + 16 |
...
| Admin consolidation | One people console — the access funnel with approve/edit/revoke attached | 🔲 Planned Jul 25, 2026 (merges the Sprint 10 roster into the Sprint 16 approval page; net −1 admin page) | 20 | before Aug 28 |

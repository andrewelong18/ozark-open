...
| [25](sprints/sprint-25.md) | Phase scheduling, close automation & countdown | 🔲 cut Jul 31, 2026. **Needs an ADR 0001 amendment first** — adds a second and third writer to a bet's status, where today only a spreadsheet upload changes it. Carries the session's September-readiness P0: the chase list and the final `completed` flip both have no UI and route through the database (#106–#108) | 22 (the import guards interact) |

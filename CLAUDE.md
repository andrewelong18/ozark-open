...
Scoring/skins/leaderboard math (stays in the Excel workbook) · bet resolution logic (results come from the admin's workbook per pick — ADR 0001) · payments (Venmo, out of band) · public access, SEO · notifications · multi-tenancy · parlays, live odds, cash-out, real-time updates · new bet categories without a code change (by design)

*(Custom admin UI was on this list until Jul 31, 2026 — see the admin-UI note in Project Conventions for what's now in scope and why.)*

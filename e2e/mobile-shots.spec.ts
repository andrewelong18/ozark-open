...
test.describe("phone-width screenshots", () => {
  ...
  test("the bet menu — open, closed, and mid-confirm", async ({ page }) => {
    ...
    await page.screenshot({ path: shot("bets-open"), fullPage: true })
    ...
    await page.screenshot({ path: shot("bets-confirm"), fullPage: true })
    ...
    await page.screenshot({ path: shot("bets-closed"), fullPage: true })
  })
  ...
  test("the two wide tables", async ({ page }) => {
    ...
    await page.screenshot({ path: shot("my-bets"), fullPage: true })
  })
  ...
  test("the admin console an admin runs from the course", async ({ page }) => {
    ...
    await page.screenshot({ path: shot("admin-close"), fullPage: true })

    await page.goto("/admin/people")
    await expect(page.getByRole("heading", { name: /People/ }).first()).toBeVisible()
    await page.screenshot({ path: shot("admin-people"), fullPage: true })
  })
})
